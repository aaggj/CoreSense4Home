...
int main(int argc, char * argv[])
{
  ...
  // factory.registerFromPlugin(loader.getOSName("init_groceries_bt_node"));
  ...
  factory.registerFromPlugin(loader.getOSName("move_arm_to_bt_node"));
  factory.registerFromPlugin(loader.getOSName("move_to_predefined_bt_node"));
  factory.registerFromPlugin(loader.getOSName("find_correct_place_bt_node"));
